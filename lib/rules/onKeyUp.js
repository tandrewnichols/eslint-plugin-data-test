...
module.exports = {
  meta: {
    docs: {
      ...
      recommended: true,
      url: 'https://github.com/tandrewnichols/eslint-plugin-data-test/tree/master/docs/rules/onKeyUp.md'
    },
    fixable: false,
    schema: handlerRule
  },
  ...
  create: function(context) {
    ...
    return {
      JSXOpeningElement: (node) => {
        ...
        if (notIgnored(type, options) && hasProp(attributes, 'onKeyUp') && !hasProp(attributes, testAttribute)) {
          context.report({
            node,
