  ...
  create: function(context) {
    ...
    return {
      JSXOpeningElement: (node) => {
        ...
        const ignoreReadonly = (options.ignoreReadonly || typeof options.ignoreReadonly === 'undefined');

        if (type === 'input' && (ignoreReadonly || !hasProp(attributes, 'readonly')) && !hasAnyProp(attributes, testAttribute)) {
          context.report({
            node,
