...
module.exports = {
  meta: {
    docs: {
      ...
      recommended: true,
      url: 'https://github.com/tandrewnichols/eslint-plugin-data-test/tree/master/docs/rules/input.md'
    },
    fixable: false,
    schema: [
      domRule[0],
  ...
  create: function(context) {
    ...
    return {
      JSXOpeningElement: (node) => {
        ...
        if (notIgnored(type, options) && type === 'input' && readonlyCondition && !hasProp(attributes, testAttribute)) {
          context.report({
            node,
